...
UC.extensionOptionsMenu = {
    ...
    CustomizableUI.createWidget({
      ...
      onBuild: function (doc) {
        let btn = _uc.createElement(doc, "toolbarbutton", {
          ...
          onclick:
            'if (event.button == 1) BrowserAddonUI.openAddonsMgr("addons://list/extension")',
        });
  ...
  handleClick: function (event) {
    ...
    const { target: menuitem, view: win } = event;
    ...
    switch (event.button) {
      case 0:
        ...
        else if (event.ctrlKey) UC.extensionOptionsMenu.browseDir(addon);
        break;
      case 1:
